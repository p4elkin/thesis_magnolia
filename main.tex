...
\worktype{Type of thesis}{Työn tyyppi} 
...
ja lainauksia tiivistelmään ei saa sisällyttää, eikä myöskään tietoja
...
kokonaisuus, joka mahtuu ykkösvälillä kirjoitettuna vaivatta
