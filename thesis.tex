...
\input{include/2-cms.tex}
\input{include/3-thesisproblem.tex}
\input{include/4-techstack.tex}
\input{include/5-architecture.tex}
\input{include/6-impl.tex}
\input{include/7-futurepossibilities.tex}
